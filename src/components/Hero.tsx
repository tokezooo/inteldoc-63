...
const Hero = () => {
  ...
  return (
    <section 
      className="overflow-hidden relative tech-gradient-bg" 
      id="hero" 
      style={{
        ...
        <div className="flex flex-col lg:flex-row gap-6 lg:gap-12 items-center">
          ...
          <div className="w-full lg:w-1/2 relative mt-6 lg:mt-0 flex justify-center md:justify-end lg:justify-end overflow-visible">
            {lottieData ? (
              ...
              <div className="relative transition-all duration-500 ease-out md:ml-[50%] lg:ml-0" style={{ 
                transform: isMobile ? 'scale(1.8) translateY(10px)' : window.innerWidth >= 768 && window.innerWidth < 1024 ? 'scale(2.4) translateX(5%) translateY(-5%)' : 'scale(2)', 
                ...
                <img 
                  ...
                  style={{ transformStyle: 'preserve-3d', marginRight: isMobile ? '0%' : '-10%' }} 
                />
              </div>
            )}
          </div>
