...
const HumanoidSection = () => {
  ...
  return (
    <div ref={sectionRef} className="relative" style={{
      height: '300vh'
    }}>
      <section className="w-full h-[70vh] py-3 md:py-6 sticky top-0 overflow-hidden relative" id="why-humanoid" style={{
        backgroundImage: "linear-gradient(to bottom, transparent 0%, transparent 60%, white 100%), url('/abstract-blue-background.jpg')",
        ...
        <div className="container px-6 lg:px-8 mx-auto h-full flex flex-col">
          ...
          <div ref={cardsContainerRef} className="relative flex-1 perspective-1000">
            {/* First Card */}
            <div 
              className={`absolute inset-0 overflow-hidden shadow-xl ${cardsVisible.first ? 'animate-card-enter' : ''}`} 
              style={{
                ...cardStyle,
                zIndex: 10,
                transform: `translateY(${cardsVisible.first ? '-30px' : '200px'}) scale(0.9)`,
                opacity: cardsVisible.first ? 1 : 0
              }}
            >
              <div className="absolute inset-0 z-0 bg-gradient-to-r from-blue-500 via-blue-400 to-blue-300" style={{
              ...
              <div className="relative z-10 p-5 sm:p-6 md:p-8 h-full flex items-start pt-8 sm:pt-10 md:pt-12 md:flex-col lg:flex-row">
                <div className="flex-1 max-w-lg">
                  ...
                  <p className="text-white/80 text-xl sm:text-2xl mt-8">
                    Больше никаких сложных расчетов и постоянного напряжения. ИИ делает все за тебя.
                  </p>
                </div>
            ...
            {/* Second Card */}
            <div 
              className={`absolute inset-0 overflow-hidden shadow-xl ${cardsVisible.second ? 'animate-card-enter' : ''}`} 
              style={{
                ...cardStyle,
                zIndex: 20,
                transform: `translateY(${cardsVisible.second ? '-65px' : '200px'}) scale(0.95)`,
                opacity: cardsVisible.second ? 1 : 0,
                pointerEvents: cardsVisible.second ? 'auto' : 'none'
              }}
            >
              <div className="absolute inset-0 z-0 bg-gradient-to-r from-transparent via-transparent to-white" style={{
                backgroundImage: "url('/background-section1.png')",
                backgroundSize: "cover",
                backgroundPosition: "top center"
              }}></div>
              ...
              <div className="relative z-10 p-5 sm:p-6 md:p-8 h-full flex items-start pt-8 sm:pt-10 md:pt-12">
                <div className="max-w-lg">
                  ...
                  <p className="text-white/80 text-xl sm:text-2xl mt-8">
                    Ешьте, пейте, занимайтесь спортом по своим правилам. ИнтелДок легко и удобно собирает данные.
                  </p>
                </div>
              </div>
            </div>
            ...
            {/* Third Card */}
            <div 
              className={`absolute inset-0 overflow-hidden shadow-xl ${cardsVisible.third ? 'animate-card-enter' : ''}`} 
              style={{
                ...cardStyle,
                zIndex: 30,
                transform: `translateY(${cardsVisible.third ? '-105px' : '200px'}) scale(1)`,
            ...
            >
              ...
              <div className="relative z-10 p-5 sm:p-6 md:p-8 h-full flex items-start justify-end pt-8 sm:pt-10 md:pt-12">
                <div className="max-w-lg text-right">
                  ...
                  <p className="text-white/80 text-xl sm:text-2xl mt-8">
                    Приложение работает незаметно и точно.<br />
          ...
          {/* Mascot behind cards */}
          <div className="absolute inset-0 z-5 flex items-center justify-start">
            <img 
